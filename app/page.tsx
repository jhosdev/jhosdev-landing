        ...
        <LayoutComponent className="pt-0">
          <div className="flex items-center justify-between w-full">
            ...
            <div className="w-1/2 flex flex-col items-center self-center">
              ...
              <h2 className="text-primary dark:text-primaryDark my-1 text-4xl font-extrabold">Full-Stack Engineer</h2>
              ...
              <div className="flex items-center self-start mt-2">
                <Link href="/CV_Jhosaim_Pocohuanca_Aug2023_EN.pdf" target={"_blank"} className="flex items-center bg-dark text-light p-2.5 px-6 rounded-lg text-lg font-semibold hover:bg-light hover:text-dark border-2 border-solid border-transparent hover:border-dark dark:bg-light dark:text-dark hover:dark:bg-dark hover:dark:text-light hover:dark:border-light" download={true}>Resume <LinkArrow className={"w-6 ml-1"}/> </Link>
